<template>
 ...
 <td><router-link :to="{name: 'EditSousCategorie', params: { id: scat.id }}" class="btn btn-success">Modifier</router-link> </td>
 <td><button @click.prevent="deleteScategorie(scat.id)" class="btn btn-danger">Supprimer</button></td>
 </tr>
 </tbody>
 </table>
 </div>
